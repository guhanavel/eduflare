...
from app.algro.encoding.encoding import beam_search_decoding
from app.algro.mcq.mcq import tokenize_sentences
from app.algro.mcq.mcq import get_keywords
from app.algro.mcq.mcq import get_sentences_for_keyword
from app.algro.mcq.mcq import generate_questions_mcq
from app.algro.mcq.mcq import generate_normal_questions
import time
...
class QGen:
    ...
    def __init__(self):
        ...
        self.s2v = Sense2Vec().from_disk('app/s2v_old')
